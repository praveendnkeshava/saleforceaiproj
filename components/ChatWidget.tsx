...
export default function ChatWidget() {
  return (
    <>
            ...
            window.initEmbeddedMessaging = function () {
              try {
                ...
                embeddedservice_bootstrap.init(
                    '00DgK000000IyVp',
                    'Praveen_Salesforce_Troop_AI_Web',
                    'https://orgfarm-e3dc0c2e97-dev-ed.develop.my.site.com/ESWPraveenSalesforceTro1768902182749',
                    {
                        scrt2URL: 'https://orgfarm-e3dc0c2e97-dev-ed.develop.my.salesforce-scrt.com'
                    }
                );
              } catch (err) {
      ...
      <Script
        src="https://orgfarm-e3dc0c2e97-dev-ed.develop.my.site.com/ESWPraveenSalesforceTro1768902182749/assets/js/bootstrap.min.js"
        strategy="afterInteractive"
        onLoad={() => {
